...
export default function NewCropForm() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-surface">
      ...
      {loadError && (
        <p className="mx-4 mb-2 text-xs text-red-500">
          Failed to load crop types. Existing crops won&apos;t appear as suggestions.
        </p>
      )}

      <div className="flex-1 px-4 pb-32 space-y-6 overflow-y-auto">
        {/* Crop type */}
        <div>
      ...
      {/* Pinned save button */}
      <div
        className="fixed bottom-0 left-0 right-0 px-4 bg-surface border-t border-mushroom/10 z-30"
      ...
      >
        ...
        <button
          ...
          className="w-full py-3 rounded-2xl bg-terra text-surface text-sm font-semibold disabled:opacity-40 active:scale-95 transition-transform"
        >
